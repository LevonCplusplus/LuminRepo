...
QT_MOC_LITERAL(1, 13, 12), // "loginClicked"
QT_MOC_LITERAL(2, 26, 0) // ""

    },
    "RegisterForm\0loginClicked\0"
};
...
void RegisterForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RegisterForm::loginClicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void RegisterForm::loginClicked()
{
